...
# Substitute: cosino, coworld-cosino, 2.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-cosino:ci)
#   SMOKE_SLUG                 game slug                        (cosino)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/cosino)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/cosino-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-cosino:ci}}"
slug="${SMOKE_SLUG:-cosino}"
